...
function aboutGraph(market: MarketCode) {
  ...
  return {
    ...
    "@graph": [
      ...
      { "@type": "AboutPage", "@id": `${canonical}#webpage`, url: canonical, name: "Über uns", description: DESCRIPTION, inLanguage: config.locale, breadcrumb: { "@id": `${canonical}#breadcrumb` }, about: { "@id": `${home}#organization` } },
    ],
  };
}
...
export default async function AboutPage({ params }: Props) {
  ...
  const editorial = market === "de"
    ? { kicker: "Magazin & Autor", title: "Wissen rund um Glaube und Partnerschaft", text: "Im Magazin schreibt Christian M. Haas über christliches Dating, Beziehungen und die Fragen, die gläubige Singles bewegen.", label: "Zum Autorenprofil", href: previewPath(market, "/magazin/christian-m-haas/") }
    : market === "ch"
